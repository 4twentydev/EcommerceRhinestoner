    ...
    <footer className="bg-dark border-t border-muted/20 py-8 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative border-t border-muted/20 mt-8 pt-8">
          ...
          {/* Jewels image at the bottom center */}
          <div className="absolute left-1/2 -translate-x-1/2 -bottom-8 w-40 flex items-center justify-center">
            <img 
              src="/images/footer-jewels.png" 
              alt="Crystal jewels" 
