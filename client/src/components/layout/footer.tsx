...
export default function Footer() {
  return (
    <footer className="bg-dark border-t border-muted/20 py-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-muted/20 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
